...
import Headphones from "../../public/images/groceries.jpg";
...
const CheckoutPage = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        const res = await axios.get(
          "http://localhost:8000/api/payment/generate-token",
          config
        );
    ...
    if (
      ...
      try {
        const res = await axios.post(
          "http://localhost:8000/api/payment/process-payment",
          body,
          config
        );
  ...
  if (typeof window !== "undefined" && success) router.push("/thank-you");
        ...
        <div className="offset-1 col-6">
          ...
          <div className="row">
            ...
            <div className="offset-1 col-7 mt-3">
              <p className="fs-5 lead">Order Item: Mini Shop Headphone Set</p>
